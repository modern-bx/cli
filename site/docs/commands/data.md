...
Эти команды находятся в неймспейсе `Core`, не требуют Bitrix-проекта и полезны в shell-скриптах. Системная команда `completion:bash` описана в отдельном разделе [Системные команды](./system.md).
