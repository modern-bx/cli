...
final class TestableSiteGetCommand extends GetCommand
{
    ...
    public function runLocal(ArrayInput $input): string
    {
    ...
    protected function executeRemotePhp(string $codename, string $code): string
    {
        ...
        return array_shift($this->remoteResponses) ?? '{"ok":true,"result":null}';
    }
}
